<?php 
	...
	if($_GET["action"] == "delete"){
		...
		if ($code == "1") {
			...
			$sql2 = "select * from s_service_report9sub where sr_id = '".$_GET[$PK_field]."'";
			...
			$sql = "delete from s_service_report9sub  where sr_id = '".$_GET[$PK_field]."'";
			@mysqli_query($conn,$sql);	
      ...
      <TBODY>
        ...
        <TR>
          ...
          <!-- <TD style="vertical-align:middle"><div align="center">
            <?php  if($rec["supply"]==0) {?>
            <a href="../service_report9/?cc=<?php   echo $rec[$PK_field]; ?>&tt=<?php   echo $rec["supply"]; ?>&page=<?php   echo $_GET['page']; ?>&<?php   echo $FK_field; ?>=<?php   echo $_REQUEST["$FK_field"];?>&cus_id=<?php   echo $rec["cus_id"];?>"><img src="../images/icons/check0.gif" width="15" height="15"></a>
            <?php  } else{?>
            <a href="../service_report9/?cc=<?php   echo $rec[$PK_field]; ?>&tt=<?php   echo $rec["supply"]; ?>&page=<?php   echo $_GET['page']; ?>&<?php   echo $FK_field; ?>=<?php   echo $_REQUEST["$FK_field"];?>&cus_id=<?php   echo $rec["cus_id"];?>"><img src="../images/icons/check1.gif" width="15" height="15"></a>
            <?php  }?>
          </div></TD> -->
          <TD style="vertical-align:middle"><div align="center">
            <?php  if($rec["st_setting"]==0) {?>
            <a href="../service_report9/?b=<?php   echo $rec[$PK_field]; ?>&s=<?php   echo $rec["st_setting"]; ?>&page=<?php   echo $_GET['page']; ?>&<?php   echo $FK_field; ?>=<?php   echo $_REQUEST["$FK_field"];?>"><img src="../icons/status_on.gif" width="10" height="10"></a>
            <?php  } else{?>
            <a href="../service_report9/?b=<?php   echo $rec[$PK_field]; ?>&s=<?php   echo $rec["st_setting"]; ?>&page=<?php   echo $_GET['page']; ?>&<?php   echo $FK_field; ?>=<?php   echo $_REQUEST["$FK_field"];?>"><img src="../icons/status_off.gif" width="10" height="10"></a>
            <?php  }?>
          </div></TD>
          <TD style="vertical-align:middle;white-space: nowrap;"><div align="center"><!-- Icons -->
