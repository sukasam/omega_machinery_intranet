	...
	?>
      ...
      <TBODY>
        ...
        <TR>
          ...
          <TD style="vertical-align:middle"><?php  $chaf = preg_replace("/\//","-",$rec["fs_id"]); ?><span class="text"><a href="../../upload/project_order/<?php  echo $chaf;?>.pdf" target="_blank" style="<?php echo $GMApprove;?>"><?php  echo $rec["fs_id"] ; ?></a></span></TD>
