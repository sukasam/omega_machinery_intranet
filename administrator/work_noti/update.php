        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb2">
            <tr>
              ...
              <td style="font-size:12px;font-family:Verdana, Geneva, sans-serif;padding:5px;"><strong>ฝ่ายที่รับแจ้ง :</strong>
                ...
                <input type="checkbox" name="get_noti1[]" value="3" <?php if(in_array(3,$get_noti)){echo 'checked';}?>> ฝ่ายโรงงาน
                ...
                <td style="border-bottom:1px solid #000000;padding-bottom:10px;font-size:12px;font-family:Verdana, Geneva, sans-serif;text-align:center;">
                  ...
                  <!-- <select name="sign_work2" id="sign_work2" style="width:50%;">
                    <?php   
                      ...
                      while($row_custec = @mysqli_fetch_array($qu_custec)){
                        ?>
                              <option value="<?php   echo $row_custec['group_id'];?>" <?php   if($row_custec['group_id'] == $sign_work2){echo 'selected';}?>><?php   echo $row_custec['group_name']. " (Tel : ".$row_custec['group_tel'].")";?></option>
                              <?php  
                      }
                    ?>
                  </select> -->
