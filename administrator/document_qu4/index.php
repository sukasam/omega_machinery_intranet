...
<LI><A class=shortcut-button href="../quotation4/index.php?mid=8"><SPAN><IMG  alt=icon src="../images/btn_back.gif"><BR><BR>Back</SPAN></A></LI>
  <LI><A class=shortcut-button href="../document_qu4/update.php?mode=add<?php  if ($param <> "") echo "&".$param; ?><?php  if(isset($_GET['fo_id'])){echo '&fo_id='.$_GET['fo_id'];}?>"><SPAN><IMG  alt=icon src="../images/pencil_48.png"><BR>
...
<!--          <TH width="14%" nowrap ><div align="center"><a>Status</a></div></TH>-->
      ...
      <TBODY>
        <?php  
					...
					$sql = " select *,$tbl_name.create_date as c_date from $tbl_name  where 1 AND target = 'QU4'";
...
-->
          ...
          <TD style="vertical-align:middle">
            <A title=Edit href="../document/update.php?mode=update&fo_id=<?php echo $_GET['fo_id'];?>&<?php  echo $PK_field; ?>=<?php  echo $rec["$PK_field"]; if($param <> "") {?>&<?php  echo $param; }?>"><IMG alt=Edit src="../images/pencil.png"></A> <A title=Delete  href="#"></A></TD>
