...
<UL class=shortcut-buttons-set> 
  ...
  <LI><A class=shortcut-button href="../document_tracking/?<?php  if($param <> "") echo $param;?>"><SPAN><IMG  alt=icon src="../images/btn_back.gif"><BR>
    <br>
    Back</SPAN></A></LI>
  <?php  }?> 
</UL>
...
<div>
 ...
 <form name="form1" method="get" action="../document_tracking/list.php">
  <input name="keyword" type="text" id="keyword" value="<?php  echo $_GET['keyword'];?>">
    ...
    <?php 
			...
			$param2 = get_param($a_param,$a_not_exists);*/
			  ?>
    <a href="../document_tracking/list.php?mode=add&id=<?php  echo $_GET['id'];?>&page=1">Show All</a>
    <?php  
			/*$a_not_exists = array();
