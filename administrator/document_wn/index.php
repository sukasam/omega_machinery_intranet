...
<?php  include('../top.php');?>
<P id=page-intro><?php  echo ucfirst ($page_name); ?> <!--  | <a href="../document_tracking/tag.php?mid=<?php  echo $_GET['mid'];?>">Tag Keyword</a>--></P>

<UL class=shortcut-buttons-set>
<LI><A class=shortcut-button href="../work_noti_tracking/?tab=<?php echo $_GET['tab'];?>&fo_id=<?php echo $_GET['fo_id'];?>"><SPAN><IMG  alt=icon src="../images/btn_back.gif"><BR><BR>Back</SPAN></A></LI>
  <LI><A class=shortcut-button href="../document_wn/update.php?mode=add<?php  if(isset($_GET['tab'])){echo '&tab='.$_GET['tab'];}?><?php  if(isset($_GET['fo_id'])){echo '&fo_id='.$_GET['fo_id'];}?><?php  if(isset($_GET['fo_id'])){echo '&fo_id2='.$_GET['fo_id2'];}?>"><SPAN><IMG  alt=icon src="../images/pencil_48.png"><BR>
...
<div>
 ...
 <form name="form1" method="get" action="../document_tracking/index.php">
  <input name="keyword" type="text" id="keyword" value="<?php  echo $_GET['keyword'];?>">
    ...
    <?php 
			...
			$param2 = get_param($a_param,$a_not_exists);*/
			  ?>
    <a href="../document_tracking/index.php?tab=<?php echo $_GET['tab'];?>&fo_id=<?php echo $_GET['fo_id'];?>&fo_id2=<?php echo $_GET['fo_id2'];?>">Show All</a>
    <?php  
			/*$a_not_exists = array();
...
<DIV id=tab1 class="tab-content default-tab"><!-- This is the target div. id must match the href of this div's tab -->
  <form name="form2" method="post" action="../document_tracking/confirm.php" onSubmit="return check_select(this)">
    <TABLE>
      <THEAD>
        <TR>
      ...
      <TBODY>
        <?php  
					...
					if ($sortby =="") $sortby ="DESC";
				   	...
				   	$sql = " select *,$tbl_name.create_date as c_date from $tbl_name  where 1 AND target = 'WO'";
...
<!--
          <TD nowrap style="vertical-align:middle"><div align="center">
            <?php  if($rec["status"]==0) {?>
            <a href="../document_tracking/?b=<?php  echo $rec[$PK_field]; ?>&s=<?php  echo $rec["status"]; ?>&fo_id=<?php echo $_GET['fo_id'];?>&page=<?php  echo $page; ?>&<?php  echo $FK_field; ?>=<?php  echo $_REQUEST["$FK_field"];?>&<?php  echo $param2;?>"><img src="../icons/status_on.gif" width="10" height="10"></a>
            <?php  } else{?>
            <a href="../document_tracking/?b=<?php  echo $rec[$PK_field]; ?>&s=<?php  echo $rec["status"]; ?>&fo_id=<?php echo $_GET['fo_id'];?>&page=<?php  echo $page; ?>&<?php  echo $FK_field; ?>=<?php  echo $_REQUEST["$FK_field"];?>&<?php  echo $param2;?>"><img src="../icons/status_off.gif" width="10" height="10"></a>
            <?php  }?>
          </div></TD>
-->
        
          <TD style="vertical-align:middle">
            <A title=Edit href="../document_tracking/update.php?mode=update&<?php  echo $PK_field; ?>=<?php  echo $rec["$PK_field"];?>&tab=<?php echo $_GET['tab'];?>&fo_id=<?php echo $_GET['fo_id'];?>&fo_id2=<?php echo $_GET['fo_id2'];?>"><IMG alt=Edit src="../images/pencil.png"></A> <A title=Delete  href="#"></A></TD>
