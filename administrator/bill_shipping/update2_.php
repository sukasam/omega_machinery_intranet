<?php   
	...
	if ($_POST["mode"] <> "") { 
		...
		if ($_POST["mode"] == "update" ) {
			...
			$mpdf->Output('../bill_shippingservice_report_close/'.$chaf.'.pdf','F');
  ...
  <tr>
    ...
    <tr>
      ...
      <select name="cpro2" id="cpro2" class="inputselect" style="width:100%;">
      		<option value="">กรุณาเลือกรายการ</option>
		  <?php  
              $qupro2 = @mysqli_query($conn,"SELECT * FROM group_stockmachine ORDER BY group_name ASC");
    ...
    <tr>
      ...
      <select name="cpro3" id="cpro3" class="inputselect" style="width:100%;">
      		<option value="">กรุณาเลือกรายการ</option>
		  <?php  
              $qupro3 = @mysqli_query($conn,"SELECT * FROM group_stockmachine ORDER BY group_name ASC");
    ...
    <tr>
      ...
      <select name="cpro4" id="cpro4" class="inputselect" style="width:100%;">
      		<option value="">กรุณาเลือกรายการ</option>
		  <?php  
              $qupro4 = @mysqli_query($conn,"SELECT * FROM group_stockmachine ORDER BY group_name ASC");
    ...
    <tr>
      ...
      <select name="cpro5" id="cpro5" class="inputselect" style="width:100%;">
      		<option value="">กรุณาเลือกรายการ</option>
		  <?php  
              $qupro5 = @mysqli_query($conn,"SELECT * FROM group_stockmachine ORDER BY group_name ASC");
