    ...
    xmlHttp.onreadystatechange=function (){
        if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete"){   
			...
			if(ds[3] <= 0){
				...
				self.opener.document.getElementById('locations'+resdata).value='';
				...
				self.opener.document.getElementById('ships'+resdata).value='';

			}else{
				//alert(resdata);
				self.opener.document.getElementById('codes'+resdata).value=ds[1];
				self.opener.document.getElementById('lists'+resdata).innerHTML=ds[2];
				self.opener.document.getElementById('locations'+resdata).value=ds[4];
				self.opener.document.getElementById('sns'+resdata).value='';
