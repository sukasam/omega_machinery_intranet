<?php    
	...
	if($_GET["action"] == "delete"){
		...
		if ($code == "1") {
			...
			$sql2 = "select * from s_bill_shippingsub where sr_id = '".$_GET[$PK_field]."'";
			...
			$sql = "delete from s_bill_shippingsub  where sr_id = '".$_GET[$PK_field]."'";
			@mysqli_query($conn,$sql);	
...
<UL class=shortcut-buttons-set>
  <LI><A class=shortcut-button href="update.php?mode=add<?php     if ($param <> "") echo "&".$param; ?>"><SPAN><IMG  alt=icon src="../images/pencil_48.png"><BR>
    เพิ่ม</SPAN></A></LI>
	<LI><A class=shortcut-button href="../group_bill_ship_approve/index_ship.php"><SPAN><IMG  alt=icon src="../images/icons/icon-48-user.png" width="48"><BR>
    อนุมัติใบจัดส่ง</SPAN></A></LI>
	<LI><A class=shortcut-button href="../bill_lading"><SPAN><IMG  alt=icon src="../images/icons/icon-48-article.png"><BR>
    ใบเบิกสินค้า</SPAN></A>
...
<DIV id=tab1 class="tab-content default-tab"><!-- This is the target div. id must match the href of this div's tab -->
  <form name="form2" method="post" action="confirm.php" onSubmit="return check_select(this)">
	...
	?>
            ...
            &nbsp;</TH>
          <TH width="10%"><div align="center"><a>Ship ID</a></div></TH>
          <TH width="30%"><a>ชื่อลูกค้า</a></TH>
          <TH width="30%"><a>สถานที่จัดส่ง</a></TH>
          <TH width="10%"><div align="center"><a>การยืนยัน</a></div></TH>
          <TH width="10%"><div align="center"><a>Open / Close</a></div></TH>
          <TH width="10%"><div align="center"><a>แก้ไข</a></div></TH>
          <TH width="10%"><div align="center"><a>ลบ</a></div></TH>
          </TR>
      </THEAD>
      <TFOOT>
        </TFOOT>
      <TBODY>
        ...
        <TR>
          ...
          <TD style="vertical-align:middle;"><?php     $chaf = preg_replace("/\//","-",$rec["sv_id"]); ?><div align="center"><span class="text"><a href="../../upload/bill_shipping/<?php     echo $chaf;?>.pdf" target="_blank"><?php     echo $rec["sv_id"] ; ?></a></span></div></TD>
          ...
          <TD style="vertical-align:middle"><div align="center">
            ...
            <a href="../bill_shipping/?b=<?php     echo $rec[$PK_field]; ?>&s=<?php     echo $rec["st_setting"]; ?>&page=<?php     echo $_GET['page']; ?>&<?php     echo $FK_field; ?>=<?php     echo $_REQUEST["$FK_field"];?>"><img src="../icons/status_on.gif" width="10" height="10"></a>
            <?php     } else{?>
            <a href="../bill_shipping/?b=<?php     echo $rec[$PK_field]; ?>&s=<?php     echo $rec["st_setting"]; ?>&page=<?php     echo $_GET['page']; ?>&<?php     echo $FK_field; ?>=<?php     echo $_REQUEST["$FK_field"];?>"><img src="../icons/status_off.gif" width="10" height="10"></a>
			<?php     }?>
			
          </div></TD>
          <TD style="vertical-align:middle;"><!-- Icons -->
            <div align="center"><A title=Edit href="update.php?mode=update&<?php     echo $PK_field; ?>=<?php     echo $rec[$PK_field]; if($param <> "") {?>&<?php     echo $param; }?>"><IMG src="../images/icons/paper_content_pencil_48.png" alt=Edit width="25" height="25" title="แก้ไข"></A><a href="../../upload/bill_shipping/<?php     echo $chaf;?>.pdf" target="_blank"><img src="../images/icon2/backup.png" width="25" height="25" title="ดาวน์โหลดรายงานช่างซ่ิอม" style="margin-left:10px;"></a></div></TD>
