<?php 
	...
	//-------------------------------------------------------------------------------------
	 ...
	 if ($_GET["action"] == "apps") { 
		 ...
		 header("Location:update3.php?mode=update&sr_id=".$ids);
...
<UL class=shortcut-buttons-set>
    ...
    <LI><A class=shortcut-button href="../service_report_project_approve/index4.php"><SPAN><IMG  alt=icon src="../images/icons/icon-48-section.png"><BR>
