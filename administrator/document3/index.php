...
<LI><A class=shortcut-button href="../project_order/index.php?mid=8"><SPAN><IMG  alt=icon src="../images/btn_back.gif"><BR><BR>Back</SPAN></A></LI>
  <LI><A class=shortcut-button href="../document3/update.php?mode=add<?php  if ($param <> "") echo "&".$param; ?><?php  if(isset($_GET['fo_id'])){echo '&fo_id='.$_GET['fo_id'];}?>"><SPAN><IMG  alt=icon src="../images/pencil_48.png"><BR>
