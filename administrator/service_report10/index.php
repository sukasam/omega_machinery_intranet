  ...
  include ("../../include/config.php");
	...
	if($_GET["action"] == "delete"){
		...
		if ($code == "1") {
			...
			$sql2 = "select * from s_service_report10sub where sr_id = '".$_GET[$PK_field]."'";
			...
			$sql = "delete from s_service_report10sub  where sr_id = '".$_GET[$PK_field]."'";
			@mysqli_query($conn,$sql);	
      ...
      <TBODY>
        ...
        <TR>
          ...
          <TD style="vertical-align:middle"><div align="center">
            ...
            <a href="../service_report10/?b=<?php   echo $rec[$PK_field]; ?>&s=<?php   echo $rec["st_setting"]; ?>&page=<?php   echo $_GET['page']; ?>&<?php   echo $FK_field; ?>=<?php   echo $_REQUEST["$FK_field"];?>"><img src="../icons/status_on.gif" width="10" height="10"></a>
            <?php  } else{?>
            <a href="../service_report10/?b=<?php   echo $rec[$PK_field]; ?>&s=<?php   echo $rec["st_setting"]; ?>&page=<?php   echo $_GET['page']; ?>&<?php   echo $FK_field; ?>=<?php   echo $_REQUEST["$FK_field"];?>"><img src="../icons/status_off.gif" width="10" height="10"></a>
            <?php  }?>
          </div></TD>
