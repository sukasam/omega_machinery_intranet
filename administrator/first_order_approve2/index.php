...
<UL class=shortcut-buttons-set>
  ...
  <LI><A class=shortcut-button href="../first_order2/index.php"><SPAN><IMG  alt=icon src="../images/icons/icon-48-section.png"><BR>
    ...
    <LI><A class=shortcut-button href="../first_order/"><SPAN><IMG  alt=icon src="../images/btn_back.gif" width="32"><BR><BR>
  กลับ</SPAN></A></LI>
    <?php  
	if ($FR_module <> "") { 
      ...
      <TBODY>
        <?php  
					...
					if ($sortby =="") $sortby ="DESC";
				   	...
				   	$sql = " select *,$tbl_name.create_date as c_date from $tbl_name  where 1 AND separate = 0 AND approve = 1";
