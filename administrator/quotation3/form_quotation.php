...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #000;">
  ...
  <p style="font-size:12px;font-weight: normal;"><strong>ทางบริษัท ออสโป คิทเช่น เซอร์วิสเซส จํากัด มีความยินดีขอเสนอราคา' . $_POST['c_title_detail'] . 'ให้พิจารณา ดังนี้</strong></p>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="" >
  <tr>
    <td style="border:0px solid #000;font-size:11px;font-family:Verdana, Geneva, sans-serif; line-height: 20px;width: 60%;">
      ...
      <p style="font-size:11px;">3. การรับประกัน ' . $_POST['guaran'] . '</p><br>
      <p style="font-size:11px;">4. ทางบริษัทฯ ขอสงวนสิทธ์ในกรณีที่ลูกค้าเช็นต์อนุมัติใบเสนอราคาแล้วนั้น หากมีการยกเลิกสัญญา หรือ การเปลี่ยนแปลงใดๆเกิดขึ้นระหว่างดำเนินการ ทางลูกค้าต้องเป็นผู้รับผิดชอบต่อความเสียหายและค่าใช้จ่ายที่เกิดขึ้น</p>
      </div>
    </td>
