<?php    
	...
	if($_GET["action"] == "delete"){
		...
		if ($code == "1") {
			...
			$sql2 = "select * from group_stockmachine_bill_pro where id_bill = '".$_GET[$PK_field]."'";
			...
			$sql = "delete from group_stockmachine_bill_pro  where id_bill = '".$_GET[$PK_field]."'";
			@mysqli_query($conn,$sql);	
...
<UL class=shortcut-buttons-set>
  <LI><A class=shortcut-button href="../group_stockmachine/index.php"><SPAN><IMG  alt=icon src="../images/menu/mn_serting06.png"><BR>
    สต๊อคสินค้า</SPAN></A></LI>
    <LI><A class=shortcut-button href="../group_stockmachine/update.php"><SPAN><IMG  alt=icon src="../images/menu/mn_serting21.png"><BR>
    ...
    <LI><A class=shortcut-button href="../report3/?mid=16&act=1"><SPAN><IMG  alt=icon src="../images/menu/mn_serting23.png"><BR>
    ...
    <TABLE>
      ...
      <TBODY>
        ...
        <TR>
          ...
          <TD><center><A title="view" href="../../upload/stockin_machine/<?php echo $rec["sub_id"];?>.pdf" target="_blank"><IMG alt="view" src="../images/icon2/backup.png" width="25"></A></center></TD>
           <TD><!-- Icons -->
