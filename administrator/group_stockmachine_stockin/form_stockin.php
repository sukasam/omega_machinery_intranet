...
for($i=0;$i<=count($_POST['cpro']);$i++){
	if($_POST['cpro'][$i] != ""){
		...
		<td style="border:1px solid #000000;padding:5;">'.get_stockmachine_id($conn,$_POST['cpro'][$i]).'</td>
		<td style="border:1px solid #000000;text-align:left;padding:5;">'.get_stockmachine_name($conn,$_POST['cpro'][$i]).'</td>
