...
<?php 
	...
	<div class="bbtxt1">'.$rowSched['cd_name'].'</div>
	<div class="bbtxt2">'.$rowSched['cd_address'].'&nbsp;'.province_name($conn,$rowSched['cd_province']).'</div>
	<div class="bbtxt3">'.$rowSched['cd_tel'].'</div>
	<div class="bbtxt31">'.$rowSched['cd_fax'].'</div>
	<div class="bbtxt4">'.$rowSched['c_contact'].'</div>
	<div class="bbtxt41">'.$rowSched['c_tel'].'</div>
	
	<div class="bbtxt5">'.get_servicename($conn,$_POST['sr_ctype']).'&nbsp;&nbsp;&nbsp;&nbsp;'.custype_name($conn,$_POST['sr_ctype2']).'</div>
	<div class="bbtxt6">'.$rowSched['fs_id'].'</div>
	...
	<div class="bx01">'.$rowSched['loc_name'].'</div>
