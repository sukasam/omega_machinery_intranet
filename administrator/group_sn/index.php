...
<DIV id=tab1 class="tab-content default-tab"><!-- This is the target div. id must match the href of this div's tab -->
  <form name="form2" method="post" action="confirm.php" onSubmit="return check_select(this)">
    <TABLE>
      <THEAD>
        <TR>
          <TH width="3%" style="vertical-align: middle;"><INPUT class=check-all type=checkbox name="ca" value="true" onClick="chkAll(this.form, 'del[]', this.checked)"></TH>
          <TH width="9%" <?php  Show_Sort_bg ("user_id", $orderby) ?> style="vertical-align: middle;"> <?php 
		$a_not_exists = array('orderby','sortby');
		$param2 = get_param($a_param,$a_not_exists);
	?>
            <?php   Show_Sort_new ("user_id", "ลำดับ.", $orderby, $sortby,$page,$param2);?>
            &nbsp;</TH>
            <TH width="12%" style="vertical-align: middle;"><center>QR Code</center></TH>
          <!--<TH width="19%" <?php  Show_Sort_bg ("group_name", $orderby) ?>>
           <?php   Show_Sort_new ("group_name", "รหัสสินค้า", $orderby, $sortby,$page,$param2);?>
            &nbsp;</TH>-->
          <TH width="20%" <?php  Show_Sort_bg ("group_name", $orderby) ?> style="vertical-align: middle;"> <?php   Show_Sort_new ("group_name", "รหัสซีรี่ย์สินค้า", $orderby, $sortby,$page,$param2);?>
            &nbsp;</TH>
         <TH width="15%" <?php  Show_Sort_bg ("group_company", $orderby) ?> style="vertical-align: middle;"> <?php   Show_Sort_new ("group_company", "ชื่อร้าน / สถานที่ติดตั้ง", $orderby, $sortby,$page,$param2);?>
  &nbsp;</TH>
  		<TH width="15%" <?php  Show_Sort_bg ("group_foid", $orderby) ?> style="vertical-align: middle;"> <?php   Show_Sort_new ("group_foid", "เลขที่ Frist Order", $orderby, $sortby,$page,$param2);?>
  &nbsp;</TH>
         <!-- <TH width="18%" <?php  Show_Sort_bg ("group_name", $orderby) ?> style="vertical-align: middle;"> <?php   Show_Sort_new ("group_name", "S/N", $orderby, $sortby,$page,$param2);?>
            &nbsp;</TH>-->
          <TH width="5%" style="vertical-align: middle;"><a>แก้ไข</a></TH>
          <TH width="4%" style="vertical-align: middle;"><a>ลบ</a></TH>
        </TR>
      </THEAD>
      <TFOOT>
        </TFOOT>
      <TBODY>
        ...
        <TR>
          ...
          <TD style="vertical-align: middle;"><center><img src="../../qrcode_gen/qrcode.php?val=<?php echo $rec["group_name"];?>" width="80"></center></TD>
          <!--<TD><span class="text"><?php  echo $rec["group_spro_id"] ; ?></span></TD>-->
          <TD style="vertical-align: middle;"><span class="text"><?php  echo $rec["group_name"] ; ?></span></TD>
          <TD style="vertical-align: middle;"><span class="text"><?php  echo $rec["group_company"] ; ?></span></TD>
          <TD style="vertical-align: middle;"><span class="text"><?php  echo $rec["group_foid"] ; ?></span></TD>
          ...
          <TD style="vertical-align: middle;"><A title="Delete"  href="#"><IMG alt=Delete src="../images/cross.png" onClick="confirmDelete('?action=delete&<?php  echo $PK_field; ?>=<?php  echo $rec[$PK_field];?>&pod=<?php echo $_GET['pod'];?>','Group  <?php  echo $rec[$PK_field];?> : <?php  echo $rec["group_name"];?>')"></A></TD>
        </TR>  
		<?php  }?>
      </TBODY>
    </TABLE>
