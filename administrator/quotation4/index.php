	...
	//-------------------------------------------------------------------------------------
	 if ($_GET['b'] <> "" and $_GET['s'] <> "") { 
		...
		if($status == 1){
			...
			@mysqli_query($conn,"INSERT INTO `s_first_order` (`fo_id`, `cd_name`, `cd_address`, `cd_province`, `cd_tel`, `cd_fax`, `cd_email`, `loc_name`, `fs_id`, `date_forder`, `cg_type`, `ctype`, `pro_type`, `po_id`, `pro_sn1`, `pro_sn2`, `pro_sn3`, `pro_sn4`, `pro_sn5`, `pro_sn6`, `pro_sn7`, `c_contact`, `c_tel`, `cpro1`, `cpro2`, `cpro3`, `cpro4`, `cpro5`, `cpro6`, `cpro7`, `camount1`, `camount2`, `camount3`, `camount4`, `camount5`, `camount6`, `camount7`, `cprice1`, `cprice2`, `cprice3`, `cprice4`, `cprice5`, `cprice6`, `cprice7`, `cs_pro1`, `cs_pro2`, `cs_pro3`, `cs_pro4`, `cs_pro5`, `cs_amount1`, `cs_amount2`, `cs_amount3`, `cs_amount4`, `cs_amount5`, `type_service`, `type_service_dsc`, `cs_sell`, `cs_ship`, `cs_setting`, `date_quf`, `date_qut`) VALUES (NULL, '".$cd_name."', '".$cd_address."', '".$cd_province."', '".$cd_tel."', '".$cd_fax."', '".$cd_email."', '".$loc_name."', '".$foid."','".$date_forder."','17','16', '".$pro_type."', '".$fs_id."', '".$pro_sn1."', '".$pro_sn2."', '".$pro_sn3."', '".$pro_sn4."', '".$pro_sn5."', '".$pro_sn6."', '".$pro_sn7."', '".$c_contact."', '".$c_tel."', '".$cpro1."', '".$cpro2."', '".$cpro3."', '".$cpro4."', '".$cpro5."', '".$cpro6."', '".$cpro7."', '".$camount1."', '".$camount2."', '".$camount3."', '".$camount4."', '".$camount5."', '".$camount6."', '".$camount7."', '".$cprice1."', '".$cprice2."', '".$cprice3."', '".$cprice4."', '".$cprice5."', '".$cprice6."', '".$cprice7."', '".$cs_pro1."', '".$cs_pro2."', '".$cs_pro3."', '".$cs_pro4."', '".$cs_pro5."', '".$cs_amount1."', '".$cs_amount2."', '".$cs_amount3."', '".$cs_amount4."', '".$cs_amount5."', '".$type_service."', '".$type_service_dsc."', '".$cs_sell."','".$date_forder."','".$date_forder."','".$date_forder."','".$date_forder."');");
...
<!--          <TH width="18%"><strong>สถานที่ติดตั้ง</strong></TH>-->
         <TH width="5%" nowrap ><div align="center"><img src="../icons/status_on.gif" width="10" height="10"> เปิด / <img src="../icons/status_off.gif" width="10" height="10"> ปิด</div></TH>
<!--
...
-->
		  ...
		  <TD style="vertical-align: middle;"><div align="center"><a href="../document_qu4/?fo_id=<?php  echo $rec[$PK_field]; ?>"><img src="../images/document.png" width="30" height="30" border="0" alt=""></a></div></TD>
