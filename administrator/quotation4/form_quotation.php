...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #000;">
  ...
  <p style="font-size:12px;"><br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ทางบริษัท ออสโป คิทเช่น เซอร์วิสเซส จํากัด มีความยินดีขอเสนอราคาสัญญาบริการรายปี  สำหรับ'.$typeS.' <br>
...
$form .= '
  <p style="font-size:12px;">
   ...
   &nbsp;&nbsp;&nbsp;&nbsp;<span style="color: green;">บัญชีออมทรัพย์ : บจก.ออสโป คิทเช่น เซอร์วิสเซส จํากัด จำกัด</span> <br>
  ...
  <p style="font-size:12px;">3. ภายใต้เงื่อนไขการทำสัญญาบริการ ทางบริษัทออสโปฯ ขอสงวนลิขสิทธิ์ให้ลูกค้าใช้น้ำยาของทางบริษัทออสโปฯเท่านั้น</p>
