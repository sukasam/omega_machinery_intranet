<?php 
	...
	$tbl_name = "s_document_tracking_gallery";
	...
	if($_REQUEST['action'] == "delete"){
			...
			//$flgDelete_thumbs = unlink("../../upload/document_tracking/".$albums_name."/thumbs/".$file_name);
			$flgDelete_images = unlink("../../upload/document_tracking/".$albums_name."/".$file_name);
...
<UL class=shortcut-buttons-set> 
  ...
  <LI><A class=shortcut-button href="../document2_tracking/?<?php  if($param <> "") echo $param;?>"><SPAN><IMG  alt=icon src="../images/btn_back.gif"><BR>
    <br>
    Back</SPAN></A></LI>
  <?php  }?> 
</UL>
...
<div>
 ...
 <form name="form1" method="get" action="../document2_tracking/list.php">
  <input name="keyword" type="text" id="keyword" value="<?php  echo $_GET['keyword'];?>">
    ...
    <?php 
			...
			$param2 = get_param($a_param,$a_not_exists);*/
			  ?>
    <a href="../document2_tracking/list.php?mode=add&id=<?php  echo $_GET['id'];?>&page=1">Show All</a>
    <?php  
			/*$a_not_exists = array();
  ...
  <form name="form2" method="post" action="confirm.php" onSubmit="return check_select(this)">
	...
	?>
      ...
      <TBODY>
        ...
        <img src="../../upload/document_tracking/<?php  echo $_GET['id'];?>/<?php  echo $rec["title_name"];?>" width="200">
		  </TD>
