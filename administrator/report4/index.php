        ...
        <DIV class=content-box-content>
          ...
          <DIV id=tab1 class="tab-content default-tab">
            ...
            <UL class=shortcut-buttons-set>
              ...
              <LI><A class=shortcut-button href="../report4/?mid=16&act=1"><SPAN><IMG alt=icon src="../images/icons/icon-48-category.png"><BR>

                    <strong>ตารางงาน<br>ฝ่ายขาย<br>
          ...
          ?>
            ...
            <DIV class=content-box>
              ...
              <DIV class=content-box-header align="right" style="padding-right:15px;">
                ...
                <H3 align="left">เลือกตามตารางงานฝ่ายขาย</H3>
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                      <tr>
                        ...
                        ?>
                          ...
                          <tr>
                          <td nowrap class="name">พนักงานขาย</td>
                          <td>
                          <select name="cs_sale" id="cs_sale" class="inputselect">
