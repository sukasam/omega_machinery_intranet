<?php 
	...
	if($_GET["action"] == "delete"){
		...
		if ($code == "1") {
			...
			$sql2 = "select * from s_service_report8sub where sr_id = '".$_GET[$PK_field]."'";
			...
			$sql = "delete from s_service_report8sub  where sr_id = '".$_GET[$PK_field]."'";
			@mysqli_query($conn,$sql);	
	...
	if($_GET['act'] == "return"){
		...
		$copydb = @mysqli_fetch_array(@mysqli_query($conn,"SELECT * FROM s_service_report8 WHERE sr_id = '".$_GET['sr_id']."'"));
		$copydb5 = @mysqli_fetch_array(@mysqli_query($conn,"SELECT * FROM s_service_report10 WHERE sr_id = '".$_GET['sr_id']."'"));
		if($copydb5['sr_id'] != $_GET['sr_id']){
		
			@mysqli_query($conn,"DELETE FROM `s_service_report10` WHERE `s_service_report10`.`sr_id` = '".$copydb5['sr_id']."'");
			@mysqli_query($conn,"DELETE FROM `s_service_report10sub` WHERE `s_service_report10sub`.`sr_id` = '".$copydb5['sr_id']."'");

			// echo "INSERT INTO `s_service_report10` (`sr_id`, `sv_id`, `cus_id`, `sr_ctype`, `sr_ctype2`, `job_open`, `job_close`, `job_balance`, `sr_stime`, `loc_pro`, `loc_seal`, `loc_sn`, `loc_clean`, `loc_contact`, `loc_contact2`, `loc_contact3`, `cs_sell`, `loc_tels`, `cl_01`, `cl_02`, `cl_03`, `cl_04`, `cl_05`, `cl_06`, `cl_07`, `cl_08`, `ckl_list`, `ckw_list`, `ckf_list`, `detail_recom`, `detail_recom2`, `detail_calpr`, `approve`, `supply`, `approve_return`, `st_setting`, `loc_date2`, `sell_date`, `loc_date3`, `detail_comment`, `create_by`, `create_date`, `update_by`, `update_date`, `delete_by`, `delete_date`) 
			// VALUES ('".$copydb['sr_id']."', '".$copydb['sv_id']."', '".$copydb['cus_id']."', '".$copydb['sr_ctype']."', '".$copydb['sr_ctype2']."', '".$copydb['job_open']."', '".$copydb['job_close']."', '".$copydb['job_balance']."', '".$copydb['sr_stime']."', '".$copydb['loc_pro']."', '".$copydb['loc_seal']."', '".$copydb['loc_sn']."', '".$copydb['loc_clean']."', '".$copydb['loc_contact']."', '".$copydb['loc_contact2']."', '".$copydb['loc_contact3']."', '".$copydb['cs_sell']."', '".$copydb['loc_tels']."', '".$copydb['cl_01']."', '".$copydb['cl_02']."', '".$copydb['cl_03']."', '".$copydb['cl_04']."', '".$copydb['cl_05']."', '".$copydb['cl_06']."', '".$copydb['cl_07']."', '".$copydb['cl_08']."', '".$copydb['ckl_list']."', '".$copydb['ckw_list']."', '".$copydb['ckf_list']."', '".$copydb['detail_recom']."', '".$copydb['detail_recom2']."', '".$copydb['detail_calpr']."', '".$copydb['approve']."', '0', '0', '".$copydb['st_setting']."', '".$copydb['loc_date2']."', '".$copydb['sell_date']."', '".$copydb['loc_date3']."', '".$copydb['detail_comment']."', '".$copydb['create_by']."', '".$copydb['create_date']."', '".$copydb['update_by']."', '".$copydb['update_date']."', '".$copydb['delete_by']."', '".$copydb['delete_date']."');";
			// exit();

			@mysqli_query($conn,"INSERT INTO `s_service_report10` (`sr_id`, `sv_id`, `cus_id`, `sr_ctype`, `sr_ctype2`, `job_open`, `job_close`, `job_balance`, `sr_stime`, `loc_pro`, `loc_seal`, `loc_sn`, `loc_clean`, `loc_contact`, `loc_contact2`, `loc_contact3`, `cs_sell`, `loc_tels`, `cl_01`, `cl_02`, `cl_03`, `cl_04`, `cl_05`, `cl_06`, `cl_07`, `cl_08`, `ckl_list`, `ckw_list`, `ckf_list`, `detail_recom`, `detail_recom2`, `detail_calpr`, `approve`, `supply`, `approve_return`, `st_setting`, `loc_date2`, `sell_date`, `loc_date3`, `detail_comment`, `create_by`, `create_date`, `update_by`, `update_date`, `delete_by`, `delete_date`) 
			VALUES ('".$copydb['sr_id']."', '".$copydb['sv_id']."', '".$copydb['cus_id']."', '".$copydb['sr_ctype']."', '".$copydb['sr_ctype2']."', '".$copydb['job_open']."', '".$copydb['job_close']."', '".$copydb['job_balance']."', '".$copydb['sr_stime']."', '".$copydb['loc_pro']."', '".$copydb['loc_seal']."', '".$copydb['loc_sn']."', '".$copydb['loc_clean']."', '".$copydb['loc_contact']."', '".$copydb['loc_contact2']."', '".$copydb['loc_contact3']."', '".$copydb['cs_sell']."', '".$copydb['loc_tels']."', '".$copydb['cl_01']."', '".$copydb['cl_02']."', '".$copydb['cl_03']."', '".$copydb['cl_04']."', '".$copydb['cl_05']."', '".$copydb['cl_06']."', '".$copydb['cl_07']."', '".$copydb['cl_08']."', '".$copydb['ckl_list']."', '".$copydb['ckw_list']."', '".$copydb['ckf_list']."', '".$copydb['detail_recom']."', '".$copydb['detail_recom2']."', '".$copydb['detail_calpr']."', '".$copydb['approve']."', '0', '0', '".$copydb['st_setting']."', '".$copydb['loc_date2']."', '".$copydb['sell_date']."', '".$copydb['loc_date3']."', '".$copydb['detail_comment']."', '".$copydb['create_by']."', '".$copydb['create_date']."', '".$copydb['update_by']."', '".$copydb['update_date']."', '".$copydb['delete_by']."', '".$copydb['delete_date']."');");		
			
			$copysubdb = @mysqli_query($conn,"SELECT * FROM `s_service_report8sub` WHERE `sr_id` = '".$_GET['sr_id']."'");
			while($rowsubdb = @mysqli_fetch_array($copysubdb)){
				if($rowsubdb['lists'] != ""){
//					@mysqli_query($conn,"INSERT INTO `s_service_report10sub` (`r_id`, `sr_id`, `codes`, `lists`, `units`, `prices`, `amounts`, `opens`, `remains`) 
//				VALUES ('".$rowsubdb['r_id']."', '".$rowsubdb['sr_id']."', '".$rowsubdb['codes']."', '".$rowsubdb['lists']."', '".$rowsubdb['units']."', '".$rowsubdb['prices']."', '".$rowsubdb['amounts']."', '".$rowsubdb['opens']."', '".$rowsubdb['remains']."');");
					...
					$sqlPro3 = "INSERT INTO `s_service_report10sub` (`r_id`, `sr_id`, `codes`, `lists`, `units`, `prices`, `amounts`, `opens`, `remains`) 
		...
		<script type="text/javascript">
        	window.location='<?php   echo "../service_report10/update.php?mode=update&sr_id=".$copydb['sr_id']."&page=1"?>';
        </script>
		<?php  		
	}
      ...
      <TBODY>
        ...
        <TR>
          ...
          <TD style="vertical-align:middle"><div align="center">
            <?php  if($rec["supply"]==0) {?>
            <a href="../service_report8/?cc=<?php   echo $rec[$PK_field]; ?>&tt=<?php   echo $rec["supply"]; ?>&page=<?php   echo $_GET['page']; ?>&<?php   echo $FK_field; ?>=<?php   echo $_REQUEST["$FK_field"];?>&cus_id=<?php   echo $rec["cus_id"];?>"><img src="../images/icons/check0.gif" width="15" height="15"></a>
            <?php  } else{?>
            <a href="../service_report8/?cc=<?php   echo $rec[$PK_field]; ?>&tt=<?php   echo $rec["supply"]; ?>&page=<?php   echo $_GET['page']; ?>&<?php   echo $FK_field; ?>=<?php   echo $_REQUEST["$FK_field"];?>&cus_id=<?php   echo $rec["cus_id"];?>"><img src="../images/icons/check1.gif" width="15" height="15"></a>
            <?php  }?>
          </div></TD>
          ...
          <TD style="vertical-align:middle"><div align="center">
            ...
            <a href="../service_report8/?b=<?php   echo $rec[$PK_field]; ?>&s=<?php   echo $rec["st_setting"]; ?>&page=<?php   echo $_GET['page']; ?>&<?php   echo $FK_field; ?>=<?php   echo $_REQUEST["$FK_field"];?>"><img src="../icons/status_on.gif" width="10" height="10"></a>
            <?php  } else{?>
            <a href="../service_report8/?b=<?php   echo $rec[$PK_field]; ?>&s=<?php   echo $rec["st_setting"]; ?>&page=<?php   echo $_GET['page']; ?>&<?php   echo $FK_field; ?>=<?php   echo $_REQUEST["$FK_field"];?>"><img src="../icons/status_off.gif" width="10" height="10"></a>
            <?php  }?>
          </div></TD>
