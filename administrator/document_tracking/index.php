...
<LI><A class=shortcut-button href="../job_tracking/?tab=<?php echo $_GET['tab'];?>&fo_id=<?php echo $_GET['fo_id'];?>"><SPAN><IMG  alt=icon src="../images/btn_back.gif"><BR><BR>Back</SPAN></A></LI>
  <LI><A class=shortcut-button href="../document_tracking/update.php?mode=add<?php  if(isset($_GET['tab'])){echo '&tab='.$_GET['tab'];}?><?php  if(isset($_GET['fo_id'])){echo '&fo_id='.$_GET['fo_id'];}?><?php  if(isset($_GET['fo_id'])){echo '&fo_id2='.$_GET['fo_id2'];}?>"><SPAN><IMG  alt=icon src="../images/pencil_48.png"><BR>
      ...
      <TBODY>
        <?php  
					...
					if ($sortby =="") $sortby ="DESC";
				   	...
				   	$sql = " select *,$tbl_name.create_date as c_date from $tbl_name  where 1 AND target = 'FO'";
