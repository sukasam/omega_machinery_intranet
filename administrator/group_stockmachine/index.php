...
<UL class=shortcut-buttons-set>
  <LI><A class=shortcut-button href="index.php"><SPAN><IMG  alt=icon src="../images/menu/mn_serting06.png"><BR>
    ...
    <LI><A class=shortcut-button href="../group_stockmachine_stockin/update.php?mode=add"><SPAN><IMG  alt='icon' src="../images/menu/mn_serting22.png"><BR>
...
<!--          <TH width="4%"><INPUT class=check-all type=checkbox name="ca" value="true" onClick="chkAll(this.form, 'del[]', this.checked)"></TH>-->
          ...
          <TH width="10%"><a>สถานะเครื่อง</a></TH>
...
<!--          <TD><INPUT type=checkbox name="del[]" value="<?php     echo $rec[$PK_field]; ?>" ></TD>-->
    ...
    <br><br>
    <div>
    	<center><a href="print.php?keyword=<?php echo $_GET['keyword'];?>" target="_blank"><input class=button name="btprint" type="button" value="พิมพ์รายการสต็อกสินค้า"></a></center>
    </div>
