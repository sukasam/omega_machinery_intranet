...
<script type="text/javascript">
	function get_customer(srid){
		...
		self.opener.document.getElementById("srid").value=srid;
		window.close();
	}
</script>
...
<?php     
	...
	while($row_cus = @mysqli_fetch_array($qu_cus)){
		?>
		 <tr>
            <td><A href="javascript:void(0);" onclick="get_customer('<?php echo $row_cus['sv_id'];?>');"><?php echo $row_cus['sv_id']." | ".$row_cus['cd_name'];?> (<?php echo $row_cus['loc_name']?>)</A></td>
          </tr>
		<?php    	
	}
  ?>
