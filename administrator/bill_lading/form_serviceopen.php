	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
		<td style="text-align:right;font-size:12px;">
			<img src="../images/form/header_bill_lading.png" width="100%" border="0" />
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb1">
          <tr>
			...
			<td width="50%">
			<strong>วันที่เบิกสินค้า  :</strong> '.format_date($_POST['job_open']).'&nbsp;&nbsp;<br><br>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb2">
      <tr>
        ...
        <td width="47%" valign="top"><strong>รายละเอียดเพิ่มเติมการเบิกสินค้า</strong><br><br>'.$_POST['detail_recom'].'</td>
      </tr>
</table>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb2">
      <tr>
        ...
        <td width="35%"><center><strong>รายการ</strong></center></td>
      ...
      <tr>
		...
		<td width="33%" style="border:1px solid #000000;font-size:10px;font-family:Verdana, Geneva, sans-serif;text-align:center;padding-top:10px;padding-bottom:10px;">
        	<table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td style="padding-top:10px;padding-bottom:10px;font-size:10px;font-family:Verdana, Geneva, sans-serif;text-align:center;"><strong>หัวหน้าฝ่าย / ตรวจสอบ</strong></td>
              </tr>
              <tr>
		...
		<td width="33%" style="border:1px solid #000000;font-size:10px;font-family:Verdana, Geneva, sans-serif;text-align:center;padding-top:10px;padding-bottom:10px;">
        	<table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td style="padding-top:10px;padding-bottom:10px;font-size:10px;font-family:Verdana, Geneva, sans-serif;text-align:center;"><strong>ผู้อนุมัติ / เบิกสินค้า</strong></td>
              </tr>
              <tr>
