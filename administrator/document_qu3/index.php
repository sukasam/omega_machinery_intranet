...
<LI><A class=shortcut-button href="../quotation3/index.php?mid=8"><SPAN><IMG  alt=icon src="../images/btn_back.gif"><BR><BR>Back</SPAN></A></LI>
  <LI><A class=shortcut-button href="../document_qu3/update.php?mode=add<?php  if ($param <> "") echo "&".$param; ?><?php  if(isset($_GET['fo_id'])){echo '&fo_id='.$_GET['fo_id'];}?>"><SPAN><IMG  alt=icon src="../images/pencil_48.png"><BR>
...
<!--          <TH width="14%" nowrap ><div align="center"><a>Status</a></div></TH>-->
      ...
      <TBODY>
        <?php  
					...
					$sql = " select *,$tbl_name.create_date as c_date from $tbl_name  where 1 AND target = 'QU3'";
