					...
					?>
							...
							?>
													...
													<tr>
														...
														<td><strong>เลขที่บริการ : <input type="text" name="sv_id" value="<?php if ($sv_id == "") {
																...
																<!--<input type="text" name="sv_id" value="<?php if ($sv_id == "") {
																												...
																												echo $sv_id;
																											}; ?>" id="sv_id" class="inpfoder" style="border:0;">-->&nbsp;&nbsp;เลขที่สัญญา :</strong> <span id="contactid"><?php echo $finfo['fs_id']; ?></span></td>
													</tr>
													<tr>
														<td><strong>จังหวัด :</strong> <span id="cusprovince"><?php echo province_name($conn, $finfo['cd_province']); ?></span></td>
														<td>
															<strong>การรับประกัน:</strong><span id="garunM"><?php if ($finfo['garun_id']) {
																												echo $finfo['garun_id'];
																											} else {
																												echo '0';
																											} ?></span> <strong>เดือน &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; เริ่ม:</strong> <span id="garunF"><?php echo $sr_date_quf; ?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong> สิ้นสุด: </strong><span id="garunT"><?php echo $sr_date_qut; ?></span>
														</td>
													</tr>
													<tr>
														...
														<td><strong>วันที่ :</strong> <span id="datef"></span><input type="text" name="job_open" readonly value="<?php if ($job_open == "") {
															...
															</script><strong> วันที่เข้าบริการ :</strong> <span id="datet"></span><input type="text" name="job_balance" readonly value="<?php if ($job_balance == "") {
																																															echo date("d/m/Y");
																																														} else {
																																															echo $job_balance;
																																														} ?>" class="inpfoder" style="width: 70px;" />
															...
															</script><input type="hidden" name="job_close" value="<?php if ($job_close == "") {
																														echo date("d/m/Y");
																													} else {
																														echo $job_close;
																													} ?>" class="inpfoder" style="width: 70px;" />&nbsp;&nbsp;&nbsp;<strong>เวลา :</strong> <input type="time" name="job_opentime" value="<?php echo $job_opentime; ?>" class="inpfoder" style="width: 70px;text-align: center;" /><input type="hidden" name="job_closetime" value="<?php echo $job_closetime; ?>" class="inpfoder" style="width: 70px;text-align: center;" />
														</td>
													</tr>
													<tr>
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb2">
													<tr>
														<td style="width: 33%;"><strong>สถานที่ติดตั้ง / ส่งสินค้า : </strong><span id="sloc_name"><?php echo $finfo['loc_name']; ?></span><br />
															<br>
															...
															<strong>เครื่องป้อนน้ำยา : </strong>
															<input type="text" name="loc_clean" value="<?php echo $loc_clean; ?>" id="loc_clean" class="inpfoder" style="width:50%;"><br />
															<br>
														...
														<td style="width: 33%;"><strong>ปริมาณน้ำยา</strong><br /><br />
																		...
																		<div class="setting" id="slapp" style="height: 188px;">
																			<div class="sc_wrap" style="height: 188px;">
																				<ul>
																					...
																					?>
																						<li><input type="checkbox" name="ckf_list2[]" onClick="CountChecks('listone',5,this,<?php echo $numfix; ?>)" value="<?php echo $row_fix['group_id']; ?>" id="checkbox<?php echo $nd; ?>" <?php if (@in_array($row_fix['group_id'], $ckf_list)) {
																																																																						echo 'checked="checked"';
																																																																					} ?>><label for="checkbox<?php echo $nd; ?>" style="font-weight:normal;"><?php echo $row_fix['group_name']; ?></label></li>
																					<?php
																						$nd++;
																					}
																					?>
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb3">
													<tr>
														<td><strong>การรับประกันการซ่อมและการบริการตรวจเซ็คบำรุง</strong><br />
															บริษัทฯใคร่ขอแสดงความขอบคุณแก่ท่านผู้มีอุปการะคุณที่ใช้เครื่องล้างจานและผลิตภัณฑ์ของออสโปทุกท่าน ด้วยความตั้งใจอันแน่วแน่ในการบริการที่เป็นเลิศ<br />
