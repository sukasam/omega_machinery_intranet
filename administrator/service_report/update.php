  ...
  <form action="update.php" method="post" enctype="multipart/form-data" name="form1" id="form1"  onSubmit="return check(this)">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb1">
          ...
          <tr>
            ...
            <td><strong>วันที่  :</strong> <span id="datef"></span><input type="text" name="job_open" readonly value="<?php  if($job_open==""){echo date("d/m/Y");}else{ echo $job_open;}?>" class="inpfoder" style="width: 70px;"/><script language="JavaScript">new tcal ({'formname': 'form1','controlname': 'job_open'});</script><strong> วันที่เข้าบริการ :</strong> <span id="datet"></span><input type="text" name="job_balance" readonly value="<?php  if($job_balance==""){echo date("d/m/Y");}else{ echo $job_balance;}?>" class="inpfoder" style="width: 70px;"/><script language="JavaScript">new tcal ({'formname': 'form1','controlname': 'job_balance'});</script><input type="hidden" name="job_close" value="<?php  if($job_close==""){echo date("d/m/Y");}else{ echo $job_close;}?>" class="inpfoder" style="width: 70px;"/>&nbsp;&nbsp;&nbsp;<strong>เวลา :</strong> <input type="time" name="job_opentime" value="<?php echo $job_opentime;?>" class="inpfoder" style="width: 70px;text-align: center;"/><input type="hidden" name="job_closetime" value="<?php echo $job_closetime;?>" class="inpfoder" style="width: 70px;text-align: center;"/></td>
          </tr>
          <tr>
