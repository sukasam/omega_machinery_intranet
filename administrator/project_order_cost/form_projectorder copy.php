...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb2" style="border:1px solid #000000;margin-top:10px;">
          <tr>
            ...
            <td style="vertical-align:top;font-size:10px;padding:5px;">
				<strong>สรุปค่าใช้จ่าย</strong><br><br>
				<strong>ช่าง OKS ขนส่งสินค้า :</strong> '.$shipL1.'<br><br>
				<strong>ค่าน้ำมัน :</strong> '.$shipL2.'<br><br>
				<strong>OMEGA ขนส่งสินค้า :</strong> '.$shipL3.'<br><br>
				<strong>ช่าง OMEGA ติดตั้ง :</strong> '.$shipL4.'<br><br>
				<strong>ค่าเดินทาง :</strong> '.$shipL5.'<br><br>
				<strong>ค่าที่พัก :</strong> '.$shipL6.'<br><br>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:10px;text-align:center;margin-top:10px;">
    ...
    <tr>
      <td colspan="5" rowspan="5" style="text-align:left;border:1px solid #000000;padding:5;vertical-align:top;padding-top:15px;"><strong>หมายเหตุ :</strong> '.nl2br($_POST['ccomment']).'<br>
</td>
	...
	<tr>
      <td style="border:1px solid #000000;padding:5;"><strong>ส่วนลด</strong></td>
      <td style="border:1px solid #000000;padding:5;text-align:right;">'.number_format($sumdiscount,2).'&nbsp;&nbsp;</td>
    </tr>
	<tr>
      <td style="border:1px solid #000000;padding:5;"><strong>คงเหลือยอดเงิน</strong></td>
      <td style="border:1px solid #000000;padding:5;text-align:right;">'.number_format($sumremainTotal,2).'&nbsp;&nbsp;</td>
    </tr>
    <tr>
