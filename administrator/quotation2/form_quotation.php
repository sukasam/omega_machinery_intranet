...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #000;">
          <tr>
            ...
            <strong>เงื่อนไขการเช่า :</strong> '.custype_name($conn,$_POST["ctype"]).'<br /><br />
			</td>
          </tr>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:11px;text-align:center;">
    <tr>
      <td width="5%" style="border:1px solid #000;border-right:0px solid #000;font-size:11px;font-family:Verdana, Geneva, sans-serif;padding:9px 5px;text-align:center;"><strong>ลำดับ</strong></td>
      <td width="35%" style="border:1px solid #000;border-right:0px solid #000;font-size:11px;font-family:Verdana, Geneva, sans-serif;padding:9px 5px;text-align:center;"><strong>รายการ</strong></td>
      <td width="10%" style="border:1px solid #000;border-right:0px solid #000;font-size:11px;font-family:Verdana, Geneva, sans-serif;padding:9px 5px;text-align:center;"><strong>จำนวน</strong></td>
      <td width="10%" style="border:1px solid #000;border-right:0px solid #000;font-size:11px;font-family:Verdana, Geneva, sans-serif;padding:9px 5px;text-align:center;"><strong>ราคา</strong></td>
      <td width="15%" style="border:1px solid #000;border-right:0px solid #000;font-size:11px;font-family:Verdana, Geneva, sans-serif;padding:9px 5px;text-align:center;"><strong>ส่วนลด</strong></td>
    ...
    <tr>
      ...
      <td style="border:1px solid #000;border-right:0px solid #000;padding:9px 5px;"><strong>รวมทั้งหมด</strong></td>
    ...
    <tr>
      ...
      <td style="border:1px solid #000;border-top:0px solid #000;border-right:0px solid #000;padding:9px 5px;"><strong>VAT 7 %</strong></td>
      <td style="border:1px solid #000;border-top:0px solid #000;padding:9px 5px;text-align:right;">'.number_format($sumpricevat,2).'&nbsp;&nbsp;</td>
    </tr>
    <tr>
      ...
      <td style="border:0px solid #000;padding:9px 5px;"></td>
      <td style="border:1px solid #000;border-top:0px solid #000;border-right:0px solid #000;padding:9px 5px;"><strong>ราคารวมทั้งสิ้น</strong></td>
      <td style="border:1px solid #000;border-top:0px solid #000;padding:9px 5px;text-align:right;">'.number_format($sumtotals,2).'&nbsp;&nbsp;</td>
    </tr>
</table>
<br>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:11px;">
    ...
    <tr>
      <td style="border:1px solid #000;border-top:0px solid #000;border-right:0px solid #000;font-size:11px;font-family:Verdana, Geneva, sans-serif;padding:9px 5px;text-align:center;">'.$profree3.'</td>
      <td style="border:1px solid #000;border-top:0px solid #000;border-right:0px solid #000;font-size:11px;font-family:Verdana, Geneva, sans-serif;padding:9px 5px;">'.$_POST["cs_pro3"].'</td>
      <td style="border:1px solid #000;border-top:0px solid #000;font-size:11px;font-family:Verdana, Geneva, sans-serif;padding:9px 5px;text-align:center;">'.$_POST["cs_amount3"].'</td>
    </tr>
  </table>
  <br><br><br><br><br><br>
  ...
  <p style="font-size:12px;">3. ระยะเวลาเช่า '.$_POST['paycon4'].' เดือน โดยสัญญาเช่าจะเริ่มต้นเมื่อทางบริษัทฯ ทำการส่งมอบสินค้าเรียบร้อยแล้ว</p>
