...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #000;">
          <tr>
            ...
            <br /> 
              <strong>ชื่อร้าน :</strong> '.$_POST["customer_name"].'
            <br /><br />
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:11px;">
  ...
  <p style="font-size:12px;">4. บริษัทฯ ขอสงวนสิทธ์ในการกำหนดให้ลูกค้าใช้น้ำยาสำหรับเครื่องทุกชนิดของบริษัท ออสโป คิทเช่น เซอร์วิสเซส จํากัด เท่านั้น ตลอดอายุสัญญาเช่า</p>
