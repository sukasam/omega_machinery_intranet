...
<head>
	...
	<title>เลือกตาม Installation - โปรเจ็ค</title>
...
<body>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tbreport">
		...
		$dbservice = "s_service_report9";

		$dbservicesub = "s_service_report9sub";
			...
			<tr>
				...
				<?php if ($_REQUEST['sh4'] == 1 || $_REQUEST['sh5'] == 1 || $_REQUEST['sh6'] == 1 || $_REQUEST['sh10'] == 1) { ?><td style="padding:0;">
						...
						<table border="0" width="100%" cellspacing="0" cellpadding="0" class="tbreport">
							...
							<?php
							//echo "SELECT * FROM  s_service_report9 WHERE sr_id = '".$row_fr['sv.sr_id']."'";
							$qu_pfirsttotal = @mysqli_query($conn, "SELECT * FROM  s_service_report9 WHERE sr_id = '" . $row_fr['sr_id'] . "'");
