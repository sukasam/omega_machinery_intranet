...
รายงานใบยืม - โปรเจ็ค<br />

ประเภทใบบริการ  : ใบยืม - โปรเจ็ค</th>
      ...
      <?php  
		...
		$dbservice = "s_service_report8";

		$dbservicesub = "s_service_report8sub";
      ...
      <tr>
			  ...
			  <td colspan="9" style="text-align:right;"> <strong>จำนวน<?php  if($_POST['sr_stock'] == "s_service_report2"){echo 'ใบยืม';}else{echo "ใบยืม";}?>ทั้งหมด&nbsp;&nbsp;<?php  echo $sum;?>&nbsp;&nbsp;รายการ&nbsp;&nbsp;</strong></td>
