...
ประเภทใบบริการ  : <?php if($ctype != ""){echo getcustom_type($conn,$ctype);}?> <?php  if($cpro != ""){echo "(".get_sparpart_id($conn,$cpro).' | '.get_sparpart_name($conn,$cpro).")";}?></th>
      ...
      <?php  
		...
		$dbservice = "s_service_report7";

		$dbservicesub = "s_service_report7sub";
      ...
      <tr>
			  ...
			  <td colspan="9" style="text-align:right;"> <strong>จำนวน<?php  if($_POST['sr_stock'] == "s_service_report7"){echo 'ใบเบิก';}else{echo "ใบเบิก";}?>ทั้งหมด&nbsp;&nbsp;<?php  echo $sum;?>&nbsp;&nbsp;รายการ&nbsp;&nbsp;</strong></td>
