<?php  
	...
	if($loc_contact != ""){
		$condition .= " AND sv.loc_contact LIKE '%".$loc_contact."%'";
	}
...
<br />        
      ...
      <tr>
        ...
        <?php  if($_REQUEST['sh8'] == 1){?><th width="9%"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tbreport">
          <tr>
			...
			<?php  if($_REQUEST['sh11'] == 1){?><th style="border:0;" width="50%">ราคาต้นทุน</th><?php  }?>
          </tr>
        </table>
       </th><?php  }?>
              ...
              <?php  if($_REQUEST['sh8'] == 1){?><td style="padding:0;">
                ...
                <?php  
					if($cpro == ""){
						...
						if($row_fr['cpro1'] != ""){
							$priceUnit = get_sparpart_uniprice($conn,$row_fr['cpro1']);
							$sumCost += $priceUnit;
							?>
							<tr>
							  <?php  if($_REQUEST['sh8'] == 1){?><td style="border:0;padding-bottom:0;" width="37%"><?php  echo get_sparpart_name($conn,$row_fr['cpro1']);?></td><?php  }?>
							  <?php  if($_REQUEST['sh11'] == 1){?><td style="border:0;padding-bottom:0;" width="37%"><?php  echo number_format($priceUnit,2);?></td><?php  }?>
							</tr>
							<?php 	
						}
					?>
					<?php  
						if($row_fr['cpro2'] != ""){
							$priceUnit = get_sparpart_uniprice($conn,$row_fr['cpro2']);
							$sumCost += $priceUnit;
							?>
							<tr>
					...
					<?php  
						if($row_fr['cpro3'] != ""){
							$priceUnit = get_sparpart_uniprice($conn,$row_fr['cpro3']);
							$sumCost += $priceUnit;
							?>
							<tr>
					...
					<?php  
						if($row_fr['cpro4'] != ""){
							$priceUnit = get_sparpart_uniprice($conn,$row_fr['cpro4']);
							$sumCost += $priceUnit;
							?>
							<tr>
					...
					<?php  
						if($row_fr['cpro5'] != ""){
							$priceUnit = get_sparpart_uniprice($conn,$row_fr['cpro5']);
							$sumCost += $priceUnit;
							?>
							<tr>
	  ...
	  ?>
      <tr>
			  <td colspan="9" align="right"><strong>ให้บริการตามการใช้อะไหล่ทั้งหมด</strong>&nbsp;&nbsp;&nbsp;<strong><?php  echo number_format($sum);?>&nbsp;&nbsp;รายการ</strong>&nbsp;&nbsp;&nbsp;&nbsp;</td>
	  </tr>
	  <tr>
	  <td colspan="9" align="right"><strong>คิดเป็นมูลค่ารวมทั้งสิ้น</strong>&nbsp;&nbsp;&nbsp;<strong><?php  echo number_format($sumCost,2);?>&nbsp;&nbsp;บาท</strong>&nbsp;&nbsp;&nbsp;&nbsp;</td>
	  </tr>
    </table>
