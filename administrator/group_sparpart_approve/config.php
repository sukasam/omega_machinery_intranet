...
<?php 
	...
	$fieldlist = array('sub_name','sub_address','sub_tel','sub_billnum','sub_billdate','sub_comment','sub_option','sub_vat','stock_date','st_setting','approve','stock_admin','stock_approve');
