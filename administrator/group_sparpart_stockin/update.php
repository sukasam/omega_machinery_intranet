				  ...
				  <table class="formFields" cellspacing="0" width="100%">
					  ...
					  <tr >
						...
						<select name="stock_admin" id="stock_admin" class="inputselect" style="width:50%;">
							<?php   //AND (group_id = 12 OR group_id = 30 OR group_id = 10 OR group_id = 16)
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:12px;text-align:center;">
	...
	<input type="button" value="Submit" id="submitF" class="button" onclick="submitForm()">
	  ...
	  <input name="stock_approve" type="hidden" id="stock_approve" value="<?php echo $stock_approve;?>">
	  <input name="stock_approve_date" type="hidden" id="stock_approve_date" value="<?php echo $stock_approve_date;?>">
