...
<title>เลือกตามใบจัดส่งสินค้า</title>
<style type="text/css">
...
รายงานใบจัดส่งสินค้า</th>
	    <th colspan="4" style="text-align:right;font-size:11px;"><?php  echo $dateshow;?></th>
      </tr>
      <tr>
        <?php  if($_REQUEST['sh16'] == 1){?><th width="5%">เลขที่ใบจัดส่ง</th><?php  }?>
        ...
        <?php  if($_REQUEST['sh4'] == 1 || $_REQUEST['sh5'] == 1){?><th width="30%"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tbreport">
          <tr>
            ...
            <?php  if($_REQUEST['sh5'] == 1){?><td style="border-bottom:none;" width="20%"><strong>จำนวนเบิก</strong></td><?php  }?>
            <?php  if($_REQUEST['sh8'] == 1){?><td style="border-bottom:none;" width="20%"><strong>จำนวนจัด</strong></td><?php  }?>
			<?php  if($_REQUEST['sh10'] == 1){?><td style="border-bottom:none;" width="20%"><strong>S/N</strong></td><?php  }?>
          </tr>
        </table></th><?php  }?>
      ...
      <?php  
		...
		$dbservice = "s_bill_shipping";
		$dbservicesub = "s_bill_shippingsub";
			...
			<tr>
              ...
              <?php  if($_REQUEST['sh4'] == 1 || $_REQUEST['sh5'] == 1 || $_REQUEST['sh8'] == 1){?><td style="padding:0;">
				...
				while($row = @mysqli_fetch_array($qu_pfirst)){
					...
					?>
					<tr>
					  <?php  if($_REQUEST['sh4'] == 1){?><td style="border-bottom:none;" width="40%"><?php  echo get_stockmachine_id($conn,$row['lists']).' | '.get_stockmachine_name($conn,$row['lists']);?></td><?php  }?>
					  <?php  if($_REQUEST['sh5'] == 1){?><td align="center" style="border-bottom:none;" width="20%"><?php  echo $row['opens'];?></td><?php  }?>
					  <?php  if($_REQUEST['sh10'] == 1){?><td align="right" style="border-bottom:none;" width="20%"><?php  echo $row['ships'];?></td><?php  }?>
					  <?php  if($_REQUEST['sh8'] == 1){?><td align="right" style="border-bottom:none;" width="20%"><?php  echo $row['sns'];?></td><?php  }?>
					</tr>
